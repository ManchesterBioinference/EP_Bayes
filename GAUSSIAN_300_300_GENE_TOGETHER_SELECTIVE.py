...
ENHANCER_GENE_INTERACTOR.executor(PR_CURVES, mode_of_code, mode_of_features_and_interactions, redo_raw_CHIA_PET_interactions = False, upstream = 300, option_correl_select = option_correl_select, kappa_0 = kappa_0, mu_0 = mu_0, alpha_0 = alpha_0, Beta_0 = Beta_0, mode_of_sampler = mode_of_sampler, number_of_samples = number_of_samples, csf_mode = True)
