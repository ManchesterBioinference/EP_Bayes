def interactions_producer_filter(generator_mode, domain, max_path, TSS_or_intra_genic_for_domain_filter, gene_or_TSS_mode):
	...
	if generator_mode == "filter_independent_generator":
		...
		f_name = 'clean_true_interactions_all_without_prom_prom_filter_independent_d{0}_{1}_max_path_{2}'.format(domain, TSS_or_intra_genic_for_domain_filter,max_path)
		...
		f_name = 'clean_true_interactions_all_without_prom_prom_{0}_{1}_d{2}_{3}_max_path_{4}'.format(filter_pro_, filter_enh_, domain, TSS_or_intra_genic_for_domain_filter, max_path)
		...
		f_name = 'clean_true_interactions_all_without_prom_prom_{0}_{1}_cop{2}_coe{3}_opt{4}_ov{5}_d{6}_{7}_max_path_{8}'.format(filter_pro_, filter_enh_, count_f_p_, count_f_e_, filter_option, ER_pro_filtered_, domain, TSS_or_intra_genic_for_domain_filter, max_path)
