...
np.savetxt(temp_output + 'ER_controled_promoters_pindexed.txt', test, fmt='%s', delimiter='\t')
...
np.savetxt(temp_output + 'Non_ER_controled_promoters_pindexed.txt', test_2, fmt='%s', delimiter='\t')
